...
export default function PrivacyPage() {
  return <PolicyPage title="Privacy Policy" updated="3 August 2026">
    ...
    <h2>Service providers</h2><p>We use trusted providers to operate the service, including Supabase for authentication and data storage, Vercel for hosting and analytics, Twilio for WhatsApp notifications and Resend for transactional email. These providers process information only to deliver their services to us and are subject to their own privacy and security terms.</p>
