...
export type Database = {
  public: {
    Tables: {
      ...
      institution_enquiries: { Row: { id: string; institution_name: string; contact_name: string; designation: string; email: string; mobile: string; city: string; participant_count: number; preferred_date: string | null; topic: string; format: string; message: string; status: string; created_at: string }; Insert: { institution_name: string; contact_name: string; designation: string; email: string; mobile: string; city: string; participant_count: number; preferred_date?: string | null; topic: string; format: string; message?: string; status?: string }; Update: { status?: string } };
