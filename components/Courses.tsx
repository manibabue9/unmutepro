const courses = [
  {
    ...
    icon: "⭐",
    description:
      "Overcome hesitation and speak English confidently in everyday and professional situations.",
    features: [
      "Confidence building",
      "Fluency improvement",
  ...
  },
  {
    ...
    icon: "🎯",
    description:
      "Prepare for interviews through guided practice, mock sessions and personal feedback.",
    features: [
  ...
  },
  {
    ...
    icon: "🤝",
    description:
      "Get individual guidance based on your current level and communication goals.",
    features: [
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-5 text-base leading-8 text-slate-600 sm:text-lg">
            Simple, practical programs focused on confidence, interviews and
            personal guidance.
          </p>
        </div>
                ...
                {course.features.map((feature) => (
                  <li
                    ...
                    className={`flex items-start gap-3 ${
                      course.featured ? "text-blue-100" : "text-slate-700"
                    }`}
                  >
        ...
        <div className="mx-auto mt-12 max-w-3xl rounded-3xl bg-[#F8FBFF] px-7 py-8 text-center sm:px-10">
          ...
          <p className="mt-3 leading-7 text-slate-600">
            Speak with our mentor and get a simple recommendation based on your
            goals and current confidence level.
          </p>
          <a
            href="#contact"
            className="mt-6 inline-flex items-center justify-center rounded-xl bg-[#00D97E] px-7 py-3.5 font-bold text-[#062B5C] shadow-md transition hover:-translate-y-1 hover:bg-[#00C970]"
          >
            Talk to Our Mentor
            <span className="ml-2" aria-hidden="true">→</span>
          </a>
